...
export const DEFAULT_THEME: StorefrontTheme = {
  ...
  vars: {
    ...
    "--wc-border": "#E8E1D6",
    "--wc-primary": "#14110F",
    "--wc-primary-fg": "#FBF9F6",
    "--wc-accent": "#B08D57",
    "--wc-accent-fg": "#14110F",
    "--wc-text": "#3A352F",
    "--wc-muted": "#8A8074",
    "--wc-heading": "#14110F",
    "--wc-font-heading": "'Cormorant Garamond', serif",
    "--wc-font-body": "'Jost', ui-sans-serif, system-ui, sans-serif",
    "--wc-weight-heading": "600",
    "--wc-weight-body": "400",
    "--wc-size-base": "16px",
  ...
  layout: {
    ...
    navStyle: "mega-menu",
    btnStyle: "outline",
    productCardStyle: "overlay-hover",
    badgeStyle: "pill",
    inputStyle: "underline",
  },
  fonts: ["Cormorant Garamond:500,600,700", "Jost:300,400,500,600"],
};
